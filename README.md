...
The npm release flow lives in [`npm-publishing.md`](./npm-publishing.md). It covers the exact version bump, verification, commit, and `NPM_TOKEN`-based publish command used for this package.
